...
if angle_of_incidence != 0:
    x_origem_wave=-math.sqrt(((1/(math.sin(angle_of_incidence_rad)**2))*y_origem_wave**2)-y_origem_wave**2)
else :
    x_origem_wave=0

if angle_of_incidence_2_rad != 0:
    x_direcao_wave2= math.sqrt(((1/(math.sin(angle_of_incidence_2_rad)**2))*200**2)-200**2)
else :
    x_direcao_wave2=0
...
y_division2=400
print(x_origem_wave)
print(x_direcao_wave2)
print(x_direcao_wave3)
...
vetor_onda1 = [x_origem_wave+x_pos_geral,0,x_pos_geral,y_division1]
